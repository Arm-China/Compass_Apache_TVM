...
def test_scatterelements(input_shapes, axis, reduction, opset_id):
    ...
    model_name = testing.gen_model_name(op_type, dim_info, axis, reduction, indices_shape, opset_id)
    ...
    input_data = testing.get_op_input(model_name, input_shapes, {"indices_data": indice_value})
