...
class DataType {
 public:
  ...
  /*! \return whether type is a floating type. */
  bool is_floating() const { return is_bfloat() || is_float(); }
  ...
  /*! \return whether type is a bfloat16 scalar type. */
  bool is_bfloat16_scalar() const { return is_bfloat16() && is_scalar(); }
