...
class VirtualMachine(object):
    ...
    def __init__(
        ...
        module : Optional[tvm.runtime.Module]
            The managed reference object to C++ class "tvm::runtime::relax_vm::VirtualMachine", if
            it is set, it will be used as the underlying member "module", otherwise the underlying
            member "module" will be created from the given "tvm.relax.Executable" object.
        """
        if module:
            self.module = module
        else:
