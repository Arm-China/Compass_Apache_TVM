...
"""The X3P specific part of AIFF register."""
...
class MtpCtrl(Register):
    field_infos = {
        ...
        "wt_int4_to_fp8_mode": FieldInfo(3, 3),
        ...
        "gptq_en": FieldInfo(19, 19),
        "fp_sat_en": FieldInfo(20, 20),
        "chan_ext_en": FieldInfo(21, 21),
        "gptq_group_mode": FieldInfo(22, 23),
        "winograd_ctrl": FieldInfo(24, 24),
        "deconv_en": FieldInfo(25, 25),
        "zp_fixed_en": FieldInfo(26, 26),
...
class MtpBeCtrl(Register):
    field_infos = {
        "wt_prec": FieldInfo(13, 16),
        "act_prec": FieldInfo(9, 12),
...
class ItpModeCcfg(Register):
    field_infos = {
        ...
        "intp_bfen": FieldInfo(3, 3),
        "intp_bfen1": FieldInfo(4, 4),
