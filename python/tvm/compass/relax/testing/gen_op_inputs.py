...
class ONNXDTypeMapping:
    def __getitem__(self, dtype_str):
        from onnx import TensorProto  # pylint: disable=import-outside-toplevel
...
ONNX_DTYPE_MAPPING = ONNXDTypeMapping()
