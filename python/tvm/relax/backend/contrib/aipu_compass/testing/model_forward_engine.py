...
from tvm.relax.backend.contrib.aipu_compass.utils import convert_to_tuple
from .darknet import LAYERTYPE, __darknetffi__
...
class RelaxModel(Model):
    ...
    def run(self, input_data):
        ...
        outputs = tvm.relax.create_executor("vm", mod=mod).evaluate()(*input_data)
