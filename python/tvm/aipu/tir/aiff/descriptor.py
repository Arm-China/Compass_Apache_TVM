...
_OUTPUT_REGISTER_INDICES = {"X2": (16, 17, 40, 41, 42, 43), "X3": (16, 17, 19, 64, 65)}


class ActDescChain(_DescChain):
    """The "activation" descriptor chain."""

    def __init__(self, descs, aipu_info):
        super().__init__(descs)
        self._out_indices = _OUTPUT_REGISTER_INDICES[aipu_info.name[:2]]
