...
class CodeGenAipuCompass(relay.ExprFunctor):
    ...
    def _gen_basic_layer_items(self, layer_type, inputs, call):
        ...
        input_shapes = [
            [1] if len(input_shape) == 0 else input_shape for input_shape in input_shapes
        ]
        output_shapes = [
            [1] if len(output_shape) == 0 else output_shape for output_shape in output_shapes
        ]
    ...
    def _gen_constant(self, const_node):
        ...
        weight_shape = [1] if len(weight_shape) == 0 else weight_shape
