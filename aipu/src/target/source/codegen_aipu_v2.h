...
/*!
 * \file aipu/src/target/source/codegen_aipu_v2.h
 */
#ifndef AIPU_TARGET_SOURCE_CODEGEN_AIPU_V2_H_
#define AIPU_TARGET_SOURCE_CODEGEN_AIPU_V2_H_
...
class CodeGenAipuV2 final : public CodeGenC {
 ...
 public:
  CodeGenAipuV2(AipuInfo aipu_info);
  std::string PrintType(DataType t);

  // Internal supporting.
 private:
  // Information of the AIPU configuration that the program is built to.
  AipuInfo aipu_info_;
...
#endif  // AIPU_TARGET_SOURCE_CODEGEN_AIPU_V2_H_
