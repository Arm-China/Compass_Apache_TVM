...
/*!
 * \file aipu/src/tir/transforms/inject_dma.cc
 */
...
PrimExpr DmaInjector::AbsoluteAddressOf(Buffer buf, PrimExpr offset, PrimExpr tec_idx) const {
  // The "cast" node is used to avoid AIPU C compiler report conversion warning.
  ...
  // TODO(aipu-team): Can't ensure whether code generation of "address_of" can
...
TVM_REGISTER_GLOBAL("aipu.tir.transform.InjectDma").set_body_typed(InjectDma);
