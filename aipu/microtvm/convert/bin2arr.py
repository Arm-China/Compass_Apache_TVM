...
parser.add_argument(
    "-L", "--linebreak-string", default="\n", help='use what to break link, defaults to "\\n"'
)
parser.add_argument(
    "-S", "--separator-string", default=", ", help='use what to separate elements, defaults to ", "'
)
parser.add_argument(
    "-H",
    "--element-prefix",
...
parser.add_argument(
    "-U", "--force-uppercase", action="store_true", help="force uppercase HEX representation"
)
parser.add_argument("-n", "--newline", action="store_true", help="add a newline on file end")
parser.add_argument("-a", "--arr-name", help="output array name")
...
if __name__ == "__main__":
    ...
    if args.output:
        ...
        with open(args.output, "w") as f:
            ...
            f.write("/*\n")
            f.write(" * Auto-generated file. Do not Modify it directly!\n")
            f.write(" */\n\n")
