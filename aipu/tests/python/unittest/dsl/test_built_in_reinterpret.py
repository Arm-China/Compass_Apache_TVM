...
@pytest.mark.parametrize("src_dtype", ("int8", "uint8", "int16", "uint16", "int32", "uint32", "float32", "float16"))
@pytest.mark.parametrize("dst_dtype", ("int8", "uint8", "int16", "uint16", "int32", "uint32", "float32", "float16"))
