...
/*! \brief Computes the all of tensor elements over given axes. */
Expr all(Expr x, Optional<Array<Integer>> axis, bool keepdims);

/*! \brief Computes the any of tensor elements over given axes. */
Expr any(Expr x, Optional<Array<Integer>> axis, bool keepdims);
