...
@T.prim_func
def func(A: T.Buffer((128, 128), "float32"), B: T.Buffer((256, 256), "float32")):
    A.vstore([0, T.Ramp(0, 2, T.vscale() * 4)], A.vload([0, T.Ramp(0, 4, T.vscale() * 4)], predicate=T.get_active_lane_mask("boolxvscalex4", 0, 13)), predicate=T.get_active_lane_mask("boolxvscalex4", 0, 13))
    """
    _assert_print(main, expected_output)
